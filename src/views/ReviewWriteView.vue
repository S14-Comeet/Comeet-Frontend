      ...
      <div class="px-5 py-6">
        ...
        <template v-if="reviewMode === 'simple'">
          ...
          <section class="mb-6">
            ...
            <div class="tasting-wheel-wrapper">
              <TastingWheel v-model="selectedFlavors" />
            </div>
          </section>
        </template>
          ...
          <section class="mb-6">
            <details class="flavor-accordion">
              ...
              <div class="accordion-content">
                <div class="flavor-container small">
                  <TastingWheel v-model="selectedFlavors" />
                </div>
              </div>
            </details>
...
import TastingWheel from '@/components/review/TastingWheel.vue'
...
const handleSubmit = async () => {
  ...
  try {
    // 1. Create base review
    const reviewResponse = await createReview({
      storeId,
      content: content.value,
      flavorIds: selectedFlavors.value,
      visitId,
      menuId,
